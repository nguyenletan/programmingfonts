...
function selectFont() {
    ...
    if (font === '') {
        font = 'cartograph';
        $('footer .subtitle').text('Fork from https://programmingfonts.tumblr.com/');
    } else {
...
function setCounter(amount) {
    if (amount === 1) {
        $('h2 :first-child').text(amount + ' ìnlight Programming Font');
    } else {
        $('h2 p:first-child').text(amount + ' ìnlight Programming Fonts');
    }
}
